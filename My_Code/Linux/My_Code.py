...
class Program(My_Code_window.Window, My_Code_Interface.My_Code_Interface):
    ...
    def __init__(self: typing.Self, *args: typing.Any, **kwargs: typing.Any) -> None:
        ...
        if language_data == f"Српски":
            ...
            self.main_screen_whisper_me_code_button_tooltip: CTkToolTip.CTkToolTip = CTkToolTip.CTkToolTip(self.main_screen_whisper_me_code_button, message=f"објасни ми шта ради код")
            ...
            self.main_screen_title_whisper_me_code_button_tooltip: CTkToolTip.CTkToolTip = CTkToolTip.CTkToolTip(self.main_screen_whisper_me_code_button, message=f"объясни мне, что делает код")
            ...
            self.main_screen_title_whisper_me_code_button_tooltip: CTkToolTip.CTkToolTip = CTkToolTip.CTkToolTip(self.main_screen_whisper_me_code_button, message=f"explain me what code does")
